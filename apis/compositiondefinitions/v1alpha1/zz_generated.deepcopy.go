...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ChartInfoProps) DeepCopyInto(out *ChartInfoProps) {
	*out = *in
	if in.Credentials != nil {
		in, out := &in.Credentials, &out.Credentials
		*out = new(Credentials)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ChartInfoProps.
func (in *ChartInfoProps) DeepCopy() *ChartInfoProps {
	if in == nil {
		return nil
	}
	out := new(ChartInfoProps)
	in.DeepCopyInto(out)
	return out
}
